  ...
  const filteredMarkets = markets.filter(market => {
    ...
    switch (timeFilter) {
      ...
      case "weekly":
        ...
        matchesTime = marketStart >= startOfWeek.getTime() && marketStart <= endOfWeek.getTime();
        break;
      ...
      case "monthly":
        ...
        matchesTime = marketStart >= startOfMonth.getTime() && marketStart <= endOfMonth.getTime();
        break;
    ...
    <ScreenWrapper>
      {loadingMarkets ? (
        ...
        <ScrollView className="pt-10">
          ...
          <Text className="font-better-bold text-xl text-white flex items-center justify-center text-center w-full">⦿</Text>
          ...
          {!loadingMarkets && !error && filteredMarkets.length === 0 && (
            <Text className="text-white text-center mt-8 font-better-regular text-lg">No markets found for the selected filters.</Text>
          )}
          {!loadingMarkets &&
            !error &&
