//this is the widget provider file. The onUpdate function is called according
//to the updatePeriodMillis in the widgetInfo file. 
// this updates the widget every 35 minutes with fresh data.


export const weatherWidgetProvider = `package com.betrweather.app.widget
